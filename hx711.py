...
class HX711:
    ...
    def __init__(self, data_pin: digitalio.DigitalInOut, clock_pin: digitalio.DigitalInOut, gain: int) -> None:
        """
        ...
        self._initialize(gain)

    def _initialize(self, gain) -> None:
        ...
        # First read to set the size
        self._read_channel(gain)
